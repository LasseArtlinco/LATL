    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleFileUpload(file, uploadArea, hiddenInput, progressBar) {
                ...
                formData.append('type', uploadArea.dataset.target.includes('slide') ? 'slideshow' : 'product');
                ...
                xhr.addEventListener('load', function() {
                    if (xhr.status === 200) {
                        try {
                            ...
                            if (response.success) {
                                // Opdater hidden input med filnavn
                                ...
                                preview.innerHTML = '<img src="' + response.url + '" alt="Preview">';
                            ...
                            alert('Upload fejlede: Serverfejl');
                        }
                    } else {
                        alert('Upload fejlede: HTTP ' + xhr.status);
                    }
                });
                
                xhr.addEventListener('error', function() {
                    alert('Upload fejlede: Netværksfejl');
                });
